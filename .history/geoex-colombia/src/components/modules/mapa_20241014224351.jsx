  ...
  return (
    <Card className="card">
      <div className="card-content" style={{ textAlign: 'center' }}>
        ...
        {countdown === 0 && <div className="next-question-message">La siguiente pregunta vendrá en...</div>}
        {countdown > 0 && <div className="next-question-message">La siguiente pregunta vendrá en {countdown}...</div>}
        {showNextQuestionMessage && countdown === 0 && <div className="next-question-message">¡Pronto aparecerá la próxima pregunta!</div>}
