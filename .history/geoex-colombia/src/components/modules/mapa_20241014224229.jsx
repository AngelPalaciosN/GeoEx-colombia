...
export default function Mapa({ onClose }) {
  ...
  const handleNextDepartment = useCallback(() => {
    ...
    setCountdown(10);
    setShowNextQuestionMessage(false); // Ocultar mensaje al iniciar nueva pregunta
    ...
    const interval = setInterval(() => {
      setCountdown(prevCountdown => {
        if (prevCountdown > 1) {
          ...
          handleNextDepartment(); // Cambiar a la siguiente pregunta
          return 0;
        }
      });
    }, 1000);
    ...
    <Card className="card">
      <div className="card-content" style={{ textAlign: 'center' }}>
        ...
        <div className="countdown">
          {countdown > 0 && <div className="countdown-timer">Tiempo restante: {countdown} segundos</div>} {/* Mostrar tiempo restante */}
